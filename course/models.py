...
class Course(GraphObject):
    ...
    auditor = Property()
    #关系 达成
    # reach = RelatedTo('TeachingObjective','Reach')
    # reach = RelatedTo('TeachingObjective')
...
class TeachingObjective(GraphObject):
    ...
    courseName = Property()
#     关系 贡献度
#     contribution = RelatedTo('IndexPoint','Contribution')
...
class IndexPoint(GraphObject):
    ...
    describe = Property()
    #关系 子项
    # subitem = RelatedTo('IndexPoint','Subitem')
